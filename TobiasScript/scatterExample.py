...
def save_plotly_figure_to_html(figure, path: str):
    """
...
def parse_args():
    ...
    Run example: python scatterExample.py -d data -b VA --sep , --uid_col 0
    """
...
@app.callback(Output("graph", "figure"), Input("dd_menu", "value"))
